...
namespace ProductsApp.Controllers
{
    ...
    {
        private DatainstanceMachine db = new DatainstanceMachine();
        ...
        public async Task<IHttpActionResult> PostMachine(Machine machine)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = machine.Machine_id }, machine);
        }
        ...
        {
            return db.Machines.Count(e => e.Machine_id == id) > 0;
        }
    }
}